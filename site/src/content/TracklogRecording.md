...
GPX tracks are allowed, so you can record your day's flight with any device which generates a timestamped GPX tracklog file with GPS position. 
...
- Do not stop and restart the recording mid-day. All scoring is done from a single continuous tracklog. If you record the hike and fly portions separately, you can use [this tool](https://merge.norcalhf.com) to merge them before submitting a combined track.
